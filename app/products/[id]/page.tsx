        ...
        <div className='flex mt-16 py-10 flex-wrap'>
            {
                result.map((product) => (
                    <div key={product.id} className='flex justify-between gap-10'>
                        {/* Left Image */}
                        <div>
                            <Image src={product.image} alt={product.name} className='h-[600px] w-[600px]' />
                        </div>
                        {/* Right Content */}
                        <div>
                            <div>
                                ...
                                <h2 className='text-2xl font-semibold text-gray-400'>{product.tagline}</h2>
                            </div>
                            <div>
                                ...
                                <div className='flex gap-x-6'>
                                    {
                                        sizes.map((size) => {
                                            return (
                                                <div className='w-8 h-8 rounded-full border duration-300 hover:shadow-xl mt-2 center'>
                                                    <span className='text-sm text-gray-600 font-bold'>{size}</span>
                                                </div>
                                            )
                                        })
                                    }
